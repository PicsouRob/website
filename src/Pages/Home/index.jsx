        ...
        <div id="home" class="relative py-6 px-8 mx-auto max-w-7xl z-20">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-10">
                <div class="w-full lg:w-1/2">
                    ...
                    <div class="">
                        <h1 class="text-white text-5xl lg:text-6xl tracking-wide font-medium">Hi! I Am</h1>
                        <h1 class="text-white text-5xl lg:text-6xl font-medium mb-4 leading-normal">Phanord Roberto</h1>
